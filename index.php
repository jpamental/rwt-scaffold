<?php 
	$article_html = '<article>
						...
						<footer><span class="author"><label>By</label> Herman Melville</span></footer>
    ...
    <h3>A Fake Third Level Heading</h3>
    <p>
    ...
    <h4>A Fake Fourth Level Heading</h4>
    <p>
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Responsive Web Typography Scaffold</title>
		...
		<![endif]-->
        <script src="js/widowtamer/widowtamer-min.js"></script>
		<!--[if lt IE 7 ]>
    ...
    <body>
        ...
        <div class="page">
        	<header role="banner" class="clearfix">
        		<h2>Responsive Web Typography Scaffold</h2>
        	</header>
        	<div class="main">
        		<div class="main-content clearfix">
        			<?php
	        			// this uses the php-typography class to replace hashes with quotes, remove orphans and a few other niceties
						include('php-typography/php-typography.php');
						$typo = new phpTypography();
						$typo->set_dewidow(TRUE);
						$article_html = $typo->process($article_html);
						echo $article_html;
					?>
